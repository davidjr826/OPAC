...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<table width="658" height="238" border="0" align="center">
		
	<form action="error_change_password1.php" method="post">
      <br/>
	   <tr>
        <td width="66" height="53">Username</td>
        <td width="217"><input type="text" name="username" size="30" required/></td>
      </tr>
	  <tr>
	  ...
	  <tr>
        <td height="40" colspan="2"><font color="red"><b>Sorry, Wrong current password. Please re-enter you current password correctly:</b></font></td>
        </tr>
	  </form>
    </table> 	
	 
