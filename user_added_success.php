...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<tr><td align="center" bgcolor="#3366CC">
		<strong>
	...
	<tr>
	<td height="65" colspan="2"><h3>New user    has been successfully added to the system:</h3></td>
	</tr>
	
	<tr>
	<td width="250" height="112" align="center"><a href="view_added_user.php" class="style1"> View added User </a></td>
	<td width="375" ><a href="add_user.php" class="style2">Add new User </a></td>
	</tr>	
    </table> 	
	 
	<br />
