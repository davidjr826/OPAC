...
if(isset($_POST['submit']))
{
	...
	$insert = mysqli_query($connect,"INSERT  INTO info_package(author,title,isbn_no,date_pub,keywords,call_no,publisher,place_pub)
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<center>
	  <strong>Enter details of the new record to be added to the database </strong>
	</center>
	...
	<form action="info_packageform.php" method="post">
	  ...
	  <tr>
        <td>Author</td>
        <td><input type="text" name="author" size="30" required pattern="([A-Z][a-z]{1,20})" 
		onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Please start with capital letter followed by small letters': '' )"/></td>
      </tr>
      <tr>
        <td>Title</td>
      ...
      <tr>
        ...
        <td><input type="year" name="date_pub" size="30" maxlength="4" required pattern="([0-9]{4})" 
		onchange="this.setCustomValidity(this.validity.patternMismatch ? 'A year should contain numeric values only e.g 2013': '' )"/></td>
      </tr>
      <tr>
        <td>Keywords</td>
