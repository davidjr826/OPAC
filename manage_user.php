...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="188" id="navigation">
        ...
        <tr>
          <td width="188"><a href="add_user.php" class="navText">Add new user  </a></td>
        </tr>
		<tr>
          <td width="188"><a href="javascript:;" class="navText">View all users </a></td>
        </tr>
        <tr>
          <td width="188"><a href="javascript:;" class="navText">View comments </a></td>
        </tr>
        <tr>
