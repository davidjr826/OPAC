...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="188" id="navigation">
		<tr>
          <td width="188" height="36"><a href="index.php" class="navText"> Login </a></td>
        </tr>
		<tr>
          <td width="188" height="36"><a href="student_advanced_opac.php" class="navText"> Advanced Search </a></td>
        </tr>
</table>
...
<table>
  <label><tr>
  <td><i>Enter your search keyword:</i></td>
...
<br />
  <br />
 <tr> <td></td><td><a href="student_advanced_opac.php" class="navText"><b>
    <input type="button" color="blue" value="Advanced Search"/>  
  </b></a>
  </td>
  </tr>
  </table>
