...
$mysql_select="SELECT * FROM users ORDER BY id DESC LIMIT 0,1";
...
echo'<td bgcolor="blue">'.'<a href="edit_record.php"><input type="submit" value="Change Role" name="edit"/></a>'.'</td>';
echo'<td bgcolor="red">'.'<a href="edit_record.php"><input type="submit" value="Block" name="edit"/></a>'.'</td>';
